...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fir(i32* %%output, i32* %%4, i32 %%9) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fir(i32* %%output, i32* %%4, i32 %%12) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
