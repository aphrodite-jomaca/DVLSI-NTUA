...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i32 %%storemerge2 to i64, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__8 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds i32* %%c, i64 %%13, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_37_count);
  llvm_cbe_tmp__9 = (signed int *)(&llvm_cbe_c[(((signed long long )llvm_cbe_tmp__8))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__8));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load i32* %%14, align 4, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__10 = (unsigned int )*llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = mul nsw i32 %%15, %%storemerge1, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_39_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add nsw i32 %%16, %%2, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_40_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = add nsw i32 %%storemerge2, -1, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_44_count);
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add nsw i32 %%storemerge2, -1, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_26_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i32 %%6 to i64, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__3 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [11 x i32]* @aesl_internal_fir.shift_reg, i64 0, i64 %%7, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_28_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i32* %%8, align 4, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__5 = (unsigned int )*llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = sext i32 %%storemerge2 to i64, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__6 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [11 x i32]* @aesl_internal_fir.shift_reg, i64 0, i64 %%10, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_31_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%9, i32* %%11, align 4, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_32_count);
...
llvm_cbe_tmp__18:
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%17, i32* %%y, align 4, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_55_count);
