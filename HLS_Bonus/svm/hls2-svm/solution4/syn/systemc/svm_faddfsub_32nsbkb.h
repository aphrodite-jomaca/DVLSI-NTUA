...
#ifndef __svm_faddfsub_32nsbkb__HH__
#define __svm_faddfsub_32nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(svm_faddfsub_32nsbkb) {
    ...
    SC_CTOR(svm_faddfsub_32nsbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
