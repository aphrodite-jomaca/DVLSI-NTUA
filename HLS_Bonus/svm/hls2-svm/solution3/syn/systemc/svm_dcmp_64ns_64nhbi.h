...
#ifndef __svm_dcmp_64ns_64nhbi__HH__
#define __svm_dcmp_64ns_64nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(svm_dcmp_64ns_64nhbi) {
    ...
    SC_CTOR(svm_dcmp_64ns_64nhbi):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
