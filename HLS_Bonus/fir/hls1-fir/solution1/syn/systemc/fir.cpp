...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_6_fu_167_p0);
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( tmp_6_fu_167_p00 );

    SC_METHOD(thread_tmp_6_fu_167_p00);
    sensitive << ( c1_load_reg_217 );

    SC_METHOD(thread_tmp_6_fu_167_p2);
    sensitive << ( data1_reg_116 );
    sensitive << ( tmp_6_fu_167_p0 );
    ...
    sc_trace(mVcdFile, c1_load_reg_217, "c1_load_reg_217");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, tmp_6_fu_167_p2, "tmp_6_fu_167_p2");
    sc_trace(mVcdFile, tmp_6_reg_222, "tmp_6_reg_222");
    ...
    sc_trace(mVcdFile, tmp_6_fu_167_p0, "tmp_6_fu_167_p0");
    sc_trace(mVcdFile, ap_NS_fsm, "ap_NS_fsm");
    sc_trace(mVcdFile, tmp_6_fu_167_p00, "tmp_6_fu_167_p00");
#endif
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        acc_reg_91 = acc_1_fu_173_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_193.read(), ap_const_lv1_0))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        i_reg_104 = i_1_reg_212.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_104 = ap_const_lv4_7;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        c1_load_reg_217 = c1_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_1_reg_212 = grp_fu_126_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_cast_reg_184 = i_cast_fu_133_p1.read();
    }
    if ((esl_seteq<1,1,1>(tmp_fu_137_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        tmp_1_reg_193 = tmp_1_fu_145_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        tmp_6_reg_222 = tmp_6_fu_167_p2.read();
    }
}

void fir::thread_acc_1_fu_173_p2() {
    acc_1_fu_173_p2 = (!tmp_6_reg_222.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_biguint<32>(tmp_6_reg_222.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_c1_address0() {
    c1_address0 =  (sc_lv<3>) (tmp_5_fu_160_p1.read());
}
...
void fir::thread_grp_fu_126_p2() {
    grp_fu_126_p2 = (!grp_fu_126_p0.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<4>(): (sc_bigint<4>(grp_fu_126_p0.read()) + sc_bigint<4>(ap_const_lv4_F));
}

void fir::thread_i_cast_fu_133_p1() {
    i_cast_fu_133_p1 = esl_sext<32,4>(i_reg_104.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<3>) (tmp_4_fu_156_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_137_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_145_p2.read(), ap_const_lv1_1))) {
        ...
        shift_reg_address0 =  (sc_lv<3>) (tmp_3_fu_151_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_145_p2() {
    tmp_1_fu_145_p2 = (!i_reg_104.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_104.read() == ap_const_lv4_0);
}

void fir::thread_tmp_3_fu_151_p1() {
    tmp_3_fu_151_p1 = esl_zext<64,4>(grp_fu_126_p2.read());
}

void fir::thread_tmp_4_fu_156_p1() {
    tmp_4_fu_156_p1 = esl_zext<64,32>(i_cast_reg_184.read());
}

void fir::thread_tmp_5_fu_160_p1() {
    tmp_5_fu_160_p1 = esl_zext<64,32>(i_cast_reg_184.read());
}

void fir::thread_tmp_6_fu_167_p0() {
    tmp_6_fu_167_p0 =  (sc_lv<4>) (tmp_6_fu_167_p00.read());
}

void fir::thread_tmp_6_fu_167_p00() {
    tmp_6_fu_167_p00 = esl_zext<32,4>(c1_load_reg_217.read());
}

void fir::thread_tmp_6_fu_167_p2() {
    tmp_6_fu_167_p2 = (!tmp_6_fu_167_p0.read().is_01() || !data1_reg_116.read().is_01())? sc_lv<32>(): sc_biguint<4>(tmp_6_fu_167_p0.read()) * sc_bigint<32>(data1_reg_116.read());
}

void fir::thread_tmp_fu_137_p3() {
    tmp_fu_137_p3 = i_reg_104.read().range(3, 3);
}
