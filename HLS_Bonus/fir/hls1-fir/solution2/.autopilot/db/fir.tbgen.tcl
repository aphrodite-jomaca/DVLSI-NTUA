...
"0": [ "acc_t8", {"typedef": [[[],"3"],""]}], 
"3": [ "uint19", {"typedef": [[[], {"scalar": "uint19"}],""]}]
}}
set moduleName fir
...
set C_modelArgList {
	{ y int 19 regular {pointer 1}  }
	{ x uint 8 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "y", "interface" : "wire", "bitwidth" : 19, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":18,"cElement": [{"cName": "y","cData": "uint19","bit_use": { "low": 0,"up": 18},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "x", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "x","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "y", "role": "default" }} , 
...
set Spec2ImplPortList { 
	y { ap_vld {  { y out_data 1 19 }  { y_ap_vld out_vld 1 1 } } }
