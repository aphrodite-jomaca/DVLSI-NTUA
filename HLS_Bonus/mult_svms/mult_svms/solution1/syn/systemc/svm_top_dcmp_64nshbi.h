...
#ifndef __svm_top_dcmp_64nshbi__HH__
#define __svm_top_dcmp_64nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(svm_top_dcmp_64nshbi) {
    ...
    SC_CTOR(svm_top_dcmp_64nshbi):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
