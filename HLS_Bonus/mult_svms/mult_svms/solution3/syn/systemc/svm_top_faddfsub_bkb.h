...
#ifndef __svm_top_faddfsub_bkb__HH__
#define __svm_top_faddfsub_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(svm_top_faddfsub_bkb) {
    ...
    SC_CTOR(svm_top_faddfsub_bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
